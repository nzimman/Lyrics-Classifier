...
## Implementation
The file lyrics_classifier.py contains the code and the list of artists can be input using the command line. There is a class *Artist* and additional functions defined.
